...
namespace KzoneSyncService.Presentation.WebApi
{
    public class FrontendResourceModule : NancyModule
    {
        ...
        public FrontendResourceModule(ISessionStorage sessionStorage)
        {
            ...
            {
                if (!Context.IsAuthenticated()) return HttpStatusCode.Unauthorized;
                return ServeAsset("hwinfo.html", "pages/");
            };

            Get["/downloaded"] = _ =>
            {
                if (!Context.IsAuthenticated()) return HttpStatusCode.Unauthorized;
                return ServeAsset("downloaded.html", "pages/");
            };
            ...
            {
                if (!Context.IsAuthenticated()) return HttpStatusCode.Unauthorized;
                return ServeAsset("downloading.html", "pages/");
            };

            Get["/server"] = _ =>
            {
                if (!Context.IsAuthenticated()) return HttpStatusCode.Unauthorized;
                return ServeAsset("server.html", "pages/");
            };

            Get["/power"] = _ =>
            {
                if (!Context.IsAuthenticated()) return HttpStatusCode.Unauthorized;
                return ServeAsset("power.html", "pages/");
            };
            ...
            Get["/assets/font/{file*}"] = parameters => ServeAsset(parameters.file, "assets/font/");
